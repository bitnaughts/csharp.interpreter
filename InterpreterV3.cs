                ...
                switch (line_parts[0]) 
                {
                    ...
                    case Keywords.Statement.Iteration.FOR:
                        ...
                        if (scope.isVariableInScope (line_parameters[1].Split (' ') [1])) {
                            ...
                            if (line_simplified) {
                                ...
                                intermediate_line = line_parts[0] + "ll (" + line_parameters[1] + "; " + line_parameters[2] + "; " + line_parameters[3] + ")";
                    ...
                    case Keywords.Statement.Iteration.FOR + "ll":
                        ...
                        if (line_simplified) {
                            ...
                            intermediate_line = script_saved[getPointer ()];
                        } else {
                            intermediate_line = line_parts[0] + " (" + line_parameters[1] + "; " + line_parameters[2] + "; " + line_parameters[3] + ") {";
                        }
...
public class ClassObj
{
    ...
    public ClassObj(string input) {
        ...
        switch (input) {
            ...
            case "ℹ":
                name = "Iterate";
                methods.Add(new Method(this, "Main", "_Entry_point_", "void", new List<Field>(){new Field("args", "String[]")}, new List<string>(){"//_New_line", "$", "String intro = \"Hello_World!\";", "bool primitive1 = false;", "bool primitive2 = true;"}));
